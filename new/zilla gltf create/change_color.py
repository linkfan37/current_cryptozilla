...
def change_col():
    ...
    for part in List:
        ...
        image = Image.open('/home/flo/projekt/new/zilla gltf create/stantard_skins2/' + part)
        #print(image)
        #print(image.mode)
        ...
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/dark pink/dark pink_"+ part, "PNG")
        rgba.putdata(Pink)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/pink/pink_"+part, "PNG")
        rgba.putdata(Cream)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/cream/cream_"+part, "PNG")
        rgba.putdata(Crocodile)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/crocodile/crocodile_"+part, "PNG")
        rgba.putdata(DarkCyan)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/dark cyan/dark cyan_"+part, "PNG")
        rgba.putdata(DarkPurple)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/dark purple/dark purple_"+part, "PNG")
        rgba.putdata(Fire)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/fire/fire_"+part, "PNG")
        rgba.putdata(Grayscale)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/grayscale/grayscale_"+part, "PNG")
        rgba.putdata(HunterGreen)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/hunter green/hunter green_"+part, "PNG")
        rgba.putdata(Independance_blue)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/independance blue/independance blue_"+part, "PNG")
        rgba.putdata(Kelly_green)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/kelly green/kelly green_"+part, "PNG")
        rgba.putdata(Light_orange)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/light orange/light orange_"+part, "PNG")
        rgba.putdata(Light_purple)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/light purple/light purple_"+part, "PNG")
        rgba.putdata(Orange)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/orange/orange_"+part, "PNG")
        rgba.putdata(Pale_Green)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/pale green/pale green_"+part, "PNG")
        rgba.putdata(Persian)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/persian green/persian green_"+part, "PNG")
        rgba.putdata(Pidgeon_Blue)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/pigeon blue/pigeon blue_"+part, "PNG")
        rgba.putdata(Red)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/red/red_"+part, "PNG")
        rgba.putdata(Violet)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/violet/violet_"+part, "PNG")
        rgba.putdata(Blue)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/blue/blue_"+part, "PNG")
        rgba.putdata(og)
        rgba.save("/home/flo/projekt/new/zilla gltf create/skins/og/og_"+part, "PNG")
