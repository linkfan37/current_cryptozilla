...
def colorchange():
    ...
    path = "/home/flo/projekt/new/mini/zilla gltf create/"
    List=get_uri_dict.getfiles(path+'stantard_skins2/',"*.png")
    for part in List:
        print('\r└[read given img data] of '+ part, end='')
        image = Image.open(path+'stantard_skins2/' + part)
        #print(image)
        #print(image.mode)
        ...
        #print(datas)
        for item in datas:
            if(item[0] == 131 and item[1]==72 and item[2]==196 and item[3]==255): #normal skin //piink normal
            ...
            elif(item[0] == 255 and item[1]==246 and item[2]==159 and item[3]==255):#belly
            ...
            elif(item[0] == 255 and item[1]==209 and item[2]==122 and item[3]==255):#berfore belly
            ...
            elif(item[0] == 255 and item[1]==229 and item[2]==127 and item[3]==255):#berfore belly
                DarkPink.append((255, 170, 170, 255))
                Pink.append((255,212,170,255))
                Cream.append((255,242,219,255))
                Crocodile.append((224,164,159,255))
                ...
                Blue.append(item)
                og.append(item)
            elif(item[0] == 197 and item[1]==47 and item[2]==222 and item[3]==255):#topspikes
        ...
        rgba.save(path + "skins/dark pink/dark pink_"+ part, "PNG")
        rgba.putdata(Pink)
        rgba.save(path+"skins/pink/pink_"+part, "PNG")
        rgba.putdata(Cream)
        rgba.save(path+"skins/cream/cream_"+part, "PNG")
        rgba.putdata(Crocodile)
        rgba.save(path+"skins/crocodile/crocodile_"+part, "PNG")
        rgba.putdata(DarkCyan)
        rgba.save(path+"skins/dark cyan/dark cyan_"+part, "PNG")
        rgba.putdata(DarkPurple)
        rgba.save(path+"skins/dark purple/dark purple_"+part, "PNG")
        rgba.putdata(Fire)
        rgba.save(path+"skins/fire/fire_"+part, "PNG")
        rgba.putdata(Grayscale)
        rgba.save(path+"skins/grayscale/grayscale_"+part, "PNG")
        rgba.putdata(HunterGreen)
        rgba.save(path+"skins/hunter green/hunter green_"+part, "PNG")
        rgba.putdata(Independance_blue)
        rgba.save(path+"skins/independance blue/independance blue_"+part, "PNG")
        rgba.putdata(Kelly_green)
        rgba.save(path+"skins/kelly green/kelly green_"+part, "PNG")
        rgba.putdata(Light_orange)
        rgba.save(path+"skins/light orange/light orange_"+part, "PNG")
        rgba.putdata(Light_purple)
        rgba.save(path+"skins/light purple/light purple_"+part, "PNG")
        rgba.putdata(Orange)
        rgba.save(path+"skins/orange/orange_"+part, "PNG")
        rgba.putdata(Pale_Green)
        rgba.save(path+"skins/pale green/pale green_"+part, "PNG")
        rgba.putdata(Persian)
        rgba.save(path+"skins/persian green/persian green_"+part, "PNG")
        rgba.putdata(Pidgeon_Blue)
        rgba.save(path+"skins/pigeon blue/pigeon blue_"+part, "PNG")
        rgba.putdata(Red)
        rgba.save(path+"skins/red/red_"+part, "PNG")
        rgba.putdata(Violet)
        rgba.save(path+"skins/violet/violet_"+part, "PNG")
        rgba.putdata(Blue)
        rgba.save(path+"skins/blue/blue_"+part, "PNG")
        rgba.putdata(og)
        rgba.save(path+"skins/og/og_"+part, "PNG")
