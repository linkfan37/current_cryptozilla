...
gltfdtocreate = exchangeimage.listcolor("/home/flo/projekt/new/zilla gltf create_teeth/gltf in/")
for g in gltfdtocreate:
    g = g.replace("/home/flo/projekt/new/zilla gltf create_teeth/gltf in/","")
    print(g+"\n")
