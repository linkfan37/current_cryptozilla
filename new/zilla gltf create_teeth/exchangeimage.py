...
gltf = GLTF2()
image = Image()
image.uri = "/home/flo/projekt/new/zilla gltf create_teeth/skins/Cream_image2.png"
gltf.images.append(image)
gltf.convert_images(ImageFormat.DATAURI)
gltf.images[0].uri  # will now be something like "data:image/png;base64,iVBORw0KGg..."
gltf.images[0].name  # will be myfile.png
...
def exchange():
    ...
    colordirlist = listcolor("/home/flo/projekt/new/zilla gltf create_teeth/skins/")
    #print(colordirlist)
    i = 0
    ...
    for color in colordirlist:
        if '.py' not in color:
            ...
            color2 = color.replace("/home/flo/projekt/new/zilla gltf create_teeth/skins/","")
